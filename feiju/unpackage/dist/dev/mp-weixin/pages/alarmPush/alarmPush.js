...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getAlarm = async () => {
      ...
      res = await api_apis.apiGetRealTimeAlarm(params);
      const allArrayDsta = flattenTopLevelArrays(res.data);
      alarmList.value = [...alarmList.value, ...allArrayDsta];
    ...
    function toSearch() {
      common_vendor.index.navigateTo({
        url: "/pages/alarmPush/search?flag=alarmPush"
      });
    }
    getAlarm();
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        i: common_vendor.o((...args) => _ctx.bottomRefresh && _ctx.bottomRefresh(...args))
      } : {
        ...
        H: common_vendor.sr(popup, "cc826d40-1", {
          "k": "popup"
        }),
        I: common_vendor.p({
          type: "bottom",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-cc826d40"]]);
